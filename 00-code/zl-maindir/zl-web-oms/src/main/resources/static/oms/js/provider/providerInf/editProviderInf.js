...
var editTelProviderInf = {
    ...
    editTelProviderInfCommit:function(){
		...
		$.ajax({
            type: 'POST',
            url: Helper.getRootPath() + '/provider/providerInf/editProviderInfCommit.do',
            data: {
            ...
            success: function(data){
                ...
                if(data.status) {
					location.href=Helper.getRootPath() + '/provider/providerInf/listProviderInf.do?operStatus=2';
                }else{
