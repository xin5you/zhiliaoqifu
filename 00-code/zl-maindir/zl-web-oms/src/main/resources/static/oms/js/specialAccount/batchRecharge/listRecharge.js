...
var listRecharge = {
	...
	searchReset:function(){
		location = Helper.getRootPath() + '/speaccount/batchRecharge/listRecharge.do';
	},
	intoAddRecharge:function(){
		var url = Helper.getRootPath()+"/speaccount/batchRecharge/intoAddRecharge.do";
		location.href=url;
	},
	intoEditRecharge:function(){
		var orderId = $(this).attr('orderId');
		var url = Helper.getRootPath()+"/speaccount/batchRecharge/intoEditRecharge.do?orderId="+orderId;
		location.href=url;
	},
	intoViewRecharge:function(){
		var orderId = $(this).attr('orderId');
		var url = Helper.getRootPath()+"/speaccount/batchRecharge/intoViewRecharge.do?orderId="+orderId;
		location.href=url;
	},
	deleteRechargeCommit:function(){
		...
		Helper.confirm("您是否删除该记录？",function(){
		    $.ajax({								  
	            url: Helper.getRootPath() + '/speaccount/batchRecharge/deleteRechargeCommit.do',
	            type: 'post',
	            dataType : "json",
	            data: {
	                "orderId": orderId
	            ...
	            success: function (result) {
	            	if(result.status){
	            		location.href=Helper.getRootPath() + '/speaccount/batchRecharge/listRecharge.do?operStatus=4';
	            	}else{
	...
	addOrderCommit:function(){
		...
		Helper.confirm("您确认提交该订单吗？",function(){
		    $.ajax({								  
	            url: Helper.getRootPath() + '/speaccount/batchRecharge/addOrderCommit.do',
	            type: 'post',
	            dataType : "json",
	            data: {
	                "orderId": orderId
	...
	addOrderAgainCommit:function(){
		...
		Helper.confirm("您确认提交该订单吗？",function(){
		    $.ajax({								  
	            url: Helper.getRootPath() + '/speaccount/batchRecharge/addOrderAgainCommit.do',
	            type: 'post',
	            dataType : "json",
	            data: {
	                "orderId": orderId
	...
	intoAddBatchInvoiceOrder:function(){
		var orderId = $(this).attr('orderId');
		var url = Helper.getRootPath()+"/speaccount/batchRecharge/intoAddBatchInvoiceOrder.do?orderId="+orderId;
		location.href=url;
	},
	intoViewBatchInvoiceOrder:function(){
		var orderId = $(this).attr('orderId');
		var url = Helper.getRootPath()+"/speaccount/batchRecharge/intoViewBatchInvoiceOrder.do?orderId="+orderId;
		location.href=url;
	}
}
