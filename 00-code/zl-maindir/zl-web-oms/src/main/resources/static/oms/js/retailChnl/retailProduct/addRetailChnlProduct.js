...
var addTelChannelProduct = {
    ...
    addTelChannelProductCommit:function(){
		...
		$.ajax({
            type: 'POST',
            url: Helper.getRootPath() + '/retailChnl/retailChnlProduct/addRetailChnlProductCommit.do',
            data: {
            		"operName" :operName,
            		"operId": operId,
            		"areaFlag":areaFlag,
            ...
            success: function(data){
                ...
                if(data.status) {
					location.href=Helper.getRootPath() + '/retailChnl/retailChnlProduct/listRetailChnlProduct.do?operStatus=1';
                }else{
