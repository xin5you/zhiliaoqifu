...
var editTelChannelProduct = {
    ...
    editTelChannelProductCommit:function(){
		...
		$.ajax({
            type: 'POST',
            url: Helper.getRootPath() + '/retailChnl/retailChnlProduct/editRetailChnlProductCommit.do',
            data: {
            		"productId" :productId,
            		"operName" :operName,
            		"operId": operId,
            ...
            success: function(data){
                ...
                if(data.status) {
					location.href=Helper.getRootPath() + '/retailChnl/retailChnlProduct/listRetailChnlProduct.do?operStatus=2';
                }else{
