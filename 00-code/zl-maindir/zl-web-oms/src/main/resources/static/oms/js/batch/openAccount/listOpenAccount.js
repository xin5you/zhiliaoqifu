...
var listOpenAccount = {
	...
	deleteOpenAccountCommit:function(){
		...
		Helper.confirm("您是否删除该记录？",function(){
		    $.ajax({								  
	            url: Helper.getRootPath() + '/batch/openAccount/deleteOpenAccountCommit.do',
	            type: 'post',
	            dataType : "json",
	            data: {
	                "orderId": orderId
	            ...
	            success: function (result) {
	            	if(result.status){
	            		location.href=Helper.getRootPath() + '/batch/openAccount/listOpenAccount.do?operStatus=4';
	            	}else{
	...
	addOrderAgainCommit:function(){
		...
		Helper.confirm("您确认提交该订单吗？",function(){
		    $.ajax({								  
	            url: Helper.getRootPath() + '/batch/openAccount/addOrderAgainCommit.do',
	            type: 'post',
	            dataType : "json",
	            data: {
	                "orderId": orderId
