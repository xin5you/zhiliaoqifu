...
var listTelChannelOrderInf = {
	...
	searchReset: function(){
		location = Helper.getRootPath() + '/retailChnl/retailChnlOrder/listRetailChnlOrderInf.do';
	},
	callBackNotifyChannel: function(){
		var channelOrderId = $(this).attr('channelOrderId');
		Helper.confirm("是否重新回调通知分销商？",function(){
		    $.ajax({								  
	            url: Helper.getRootPath() + '/retailChnl/retailChnlOrder/doCallBackNotifyChannel.do',
	            type: 'post',
	            dataType : "json",
	            data: {
