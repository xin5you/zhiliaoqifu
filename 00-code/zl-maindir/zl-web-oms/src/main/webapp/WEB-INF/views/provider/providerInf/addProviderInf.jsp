...
<head>
    ...
    <%@ include file="/WEB-INF/views/common/head.jsp"%>
     <script src="${ctx}/static/oms/js/provider/providerInf/addProviderInf.js"></script>
</head>
            ...
            <div id="contentwrapper">
                <div class="main_content">
                	<nav>
					 ...
					 <div class="row-fluid">
					 	<div class="span12">
							<form action="${ctx }/provider/providerInf/addProviderInfCommit.do" id="mainForm"  class="form-horizontal form_validation_tip" method="post" enctype="multipart/form-data" >
					     		...
					     		<%-- <div class="control-group formSep">
						             ...
						             <div class="controls">
											 ...
											 <c:forEach var="bList" items="${billingTypeList}" varStatus="st">
											 		<option value="${bList.bId}">${bList.bName}</option>
											 </c:forEach>
			                                </select>
						             </div>
					     		</div> --%>
                                ...
                                <div class="control-group formSep">
                                    ...
                                    <div class="controls">
                                          <input type="text" class="span6" id="operSolr" name="operSolr" maxlength="10" onkeyup="this.value=this.value.replace(/\D/g,'')"/>
                                          <span class="help-block"></span>
                                    </div>
                                </div>
