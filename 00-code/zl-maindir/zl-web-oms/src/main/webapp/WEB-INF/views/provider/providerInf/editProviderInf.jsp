...
<head>
    ...
    <%@ include file="/WEB-INF/views/common/head.jsp"%>
     <script src="${ctx}/static/oms/js/provider/providerInf/editProviderInf.js"></script>
</head>
<body>
            ...
            <div id="contentwrapper">
                <div class="main_content">
                	<nav>
					 ...
					 <div class="row-fluid">
					 	<div class="span12">
							<form action="${ctx }/provider/providerInf/editProviderInfCommit.do" id="mainForm"  class="form-horizontal form_validation_tip" method="post" enctype="multipart/form-data" >
								...
								<div class="control-group formSep">
					     		...
					     		<div class="control-group formSep">
						             ...
						             <div class="controls">
											 ...
											 <c:forEach var="drList" items="${billingTypeList}" varStatus="st">
											 		<option value="${drList.bId}" <c:if test="${drList.bId == telProviderInf.bId }">selected="selected""</c:if> >${drList.bName}</option>
											 </c:forEach>
			                                </select>
						             </div>
					     		</div>
                                ...
                                <div class="control-group">
                                     ...
                                     <div class="controls">
                                          <textarea  rows="4" class="span6" name="remarks" id = "remarks" maxlength="256">${providerInf.remarks}</textarea>
                                     </div>
                                </div>
						       <div class="control-group">
			                            <div class="controls">
			                            <sec:authorize access="hasRole('ROLE_PROVIDER_EDITCOMMIT')">
