...
<head>
    ...
    <script src="${ctx}/static/oms/js/retailChnl/retailChnlReserve/addRetailChnlReserve.js"></script>
</head>
                	...
                	<nav>
			            <div id="jCrumbs" class="breadCrumb module">
			                <ul>
			                    ...
			                    <li>手机充值</li>
			                    <li><a href="${ctx }/retailChnl/retailChnlReserve/listRetailChnlReserve.do">备付金管理</a></li>
			                     <li>新增备付金</li>
			                </ul>
			            </div>
			        </nav>
					 <div class="row-fluid">
					 	<div class="span12">
							<form id="mainForm" action="${ctx }/retailChnl/retailChnlReserve/addRetailChnlReserveCommit.do" class="form-horizontal form_validation_tip" method="post" enctype="multipart/form-data">
								 <h3 class="heading">新增备付金</h3>
							             ...
							             <div class="controls">
                                                ...
                                                <option value="">--请选择--</option>
                                                 <c:forEach var="c" items="${retailChnlInfList}">
