...
<head>
    ...
    <script src="${ctx}/static/oms/js/specialAccount/bathOpenAccount/listOpenAccount.js"></script>
</head>
<body>
				                 ...
				                 <tr>
				                    ...
				                    <td>
					                    <c:if test="${entity.orderStat=='草稿' }">
		                                    <%-- <sec:authorize access="hasRole('ROLE_SPE_BATCH_OPEN_ACCOUNT_ORDERCOMMIT')"> --%>
		                                    	<a orderId="${entity.orderId }" title="提交" class="btn-mini btn-submit" href="#"><i class="icon-ok"></i></a>
		                                    <%-- </sec:authorize>
						                    <sec:authorize access="hasRole('ROLE_SPE_BATCH_OPEN_ACCOUNT_INTOEDIT')"> --%>
												<a orderId="${entity.orderId }" title="编辑" class="btn-mini btn-edit" href="#"><i class="icon-edit"></i></a>
											<%-- </sec:authorize>
											<sec:authorize access="hasRole('ROLE_SPE_BATCH_OPEN_ACCOUNT_DELETE')"> --%>
