...
<head>
    ...
    <%@ include file="/WEB-INF/views/common/head.jsp"%>
        <script src="${ctx}/static/oms/js/diy/diyResource/editDiyResource.js"></script>
</head>
<body>
							...
							<form id="mainForm" class="form-horizontal form_validation_tip" method="post">
								<input type="hidden" id="resourceId" name="resourceId" value="${diyResource.id }">
						         ...
						         <div class="control-group">
						             ...
						             <div class="controls">
						                 <input type="text" class="span6" id="resourceKey" name="resourceKey" value="${diyResource.resourceKey }"/>
						                 <span class="help-block"></span>
						             </div>
						         </div>
						         <div class="control-group">
