...
<head>
    ...
    <%@ include file="/WEB-INF/views/common/head.jsp"%>
      ...
      <script src="${ctx}/static/oms/js/specialAccount/billingType/addBillingType.js"></script>
							...
							<form id="mainForm1" class="form-horizontal" method="post">
								 <h3 class="heading">新增账户类型</h3>
								       ...
								       <div class="control-group formSep">
							             ...
							             <div class="controls">
							                 <input type="text" class="span6" id="bName" name="bName" />
							             ...
							             <div class="controls">
							                 <input type="text" class="span6" id="loseFee" name="loseFee" />
							                 <span class="help-block"></span>
							             </div>
							             </div>
							             <div class="control-group formSep">
							             ...
							             <div class="controls">
							                 <input type="text" class="span6" id="buyFee" name="buyFee" />
							                 <span class="help-block"></span>
							             </div>
							             </div>
