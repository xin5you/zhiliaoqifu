            ...
            <div id="contentwrapper">
                <div class="main_content">
					...
					<form id="pageMainForm" action="${ctx }/speaccount/batchRecharge/intoAddRecharge.do" class="form-inline form_validation_tip" method="post">
							 ...
							 <div class="span12">
		                       	...
		                       	<div class="control-group formSep">
		                       	    ...
		                       	    <span class="add-on">充值账户：</span>
                                        ...
                                        <c:forEach var="billing" items="${billingList}" varStatus="sta">
                                            <option value="${billing.bId}"   >${billing.name}</option>
                                        </c:forEach>
                                        </select>
                                        </span>
				      ...
				      <a href="${ctx }/speaccount/batchRecharge/listRecharge.do"><button class="btn btn-primary" type="button">返回</button></a>
				      </form>
			   </div>
	    </div>
