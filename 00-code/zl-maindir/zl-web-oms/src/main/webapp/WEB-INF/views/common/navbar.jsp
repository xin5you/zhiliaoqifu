                 ...
                 <div class="navbar-inner">
                     <div class="container-fluid">
                         ...
                         <sec:authorize access="hasRole('ROLE_RETAIL_CHNL_MANAGE')">
                             ...
                             <sec:authorize access="hasRole('ROLE_COMPANY_MANAGE')">
                             <li class="dropdown">
