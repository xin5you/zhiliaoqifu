	...
	<body>
		...
		<div id="contentwrapper">
			<div class="main_content">
				...
				<form id="searchForm" action="${ctx }/provider/providerOrderInf/listProviderOrderInf.do" class="form-inline" method="post">
					...
					<div class="row-fluid">
						<div class="span12">
							<div class="input-prepend">
	           			   	   	...
	           			   	   	<input id="regOrderId" name="regOrderId" type="text" class="input-medium" value="${providerOrderInf.regOrderId }" />
	                       	</div>
	                       	<div class="input-prepend">
	           			   	   	<span class="add-on">渠道订单号</span>
	           			   	   	<input id="channelOrderId" name="channelOrderId" type="text" class="input-medium" value="${providerOrderInf.channelOrderId }"/>
	                       	</div>
	
	                       	<div class="input-prepend">
	           			   	   	<span class="add-on">供应商流水号</span>
	           			   	   	<input id="billId" name="billId" type="text" class="input-medium" value="${providerOrderInf.billId }" />
	                       	</div>
	                       	<div class="input-prepend">
								...
								<select name="rechargeState" id="rechargeState" class="input-medium">
			                     	...
			                     	<c:forEach var="s" items="${rechargeStateList}" varStatus="sta">
			                     		<option value="${s.code}"  <c:if test="${s.code==providerOrderInf.rechargeState}">selected</c:if> >${s.value }</option>
			                     	</c:forEach>
			                    </select>
							</div>
