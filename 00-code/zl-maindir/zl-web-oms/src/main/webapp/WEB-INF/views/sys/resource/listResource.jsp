...
<head>
    ...
    <link href="${ctx}/static/css/master.css" rel="stylesheet" type="text/css" />
  	<link href="${ctx}/static/css/jquery.treeTable.css" rel="stylesheet" type="text/css" />
    <script src="${ctx}/static/jquery/jquery.treeTable.min.js"></script>
    <script src="${ctx}/static/oms/js/sys/resource/listResource.js"></script>
</head>
<body>
				         ...
				         <table class="table table-striped table-bordered dTableR table-hover" id="dt_gal">
				             ...
				             <c:forEach var="resource" items="${pageInfo}" varStatus="st">
				                 ...
				                 >
									...
									<td>${resource.seq}</td>
									<td>${resource.icon}</td>
									<%-- <td><c:if test="${resource.dataStat =='0'}">正常</c:if><c:if test="${resource.dataStat =='1'}">停用</c:if></td> --%>
				                    <td>
