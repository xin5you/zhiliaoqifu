...
<head>
    ...
    <script src="${ctx}/static/oms/js/retailChnl/retailChnlInf/listRetailChnlProductRate.js"></script>
</head>
<body>
	   <%@ include file="/WEB-INF/views/common/navbar.jsp"%>
            <div id="contentwrapper">
                <div class="main_content">
					...
					<form id="searchForm" action="${ctx }/retailChnl/retailChnlInf/intoAddRetailChnlRate.do?channelId=${telChannelInf.channelId }" class="form-inline" method="post">
						<input type="hidden" id="operStatus"  value="${operStatus }"/>
						<input type="hidden" id="channelId" name = "channelId" value="${retailChnlInf.channelId }"/>
						<h3 class="heading">${retailChnlInf.channelName }充值产品信息列表</h3>
						<div class="row-fluid" id="h_search">
				         ...
				         <table class="table table-striped table-bordered dTableR table-hover" id="dt_gal" >
				             ...
				             <tbody>
				             <c:forEach var="entity" items="${retailChnlProductistCheck}" varStatus="st">
				                 <tr>
				                 	<td>
