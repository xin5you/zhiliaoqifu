...
<script src="${ctx}/static/oms/js/diy/diyUser/listDiyUser.js"></script>
</head>
<body>
			...
			<div class="row-fluid" id="h_search">
				<div class="span12">
					<%-- <div class="input-prepend">
						<span class="add-on">所属分销商</span> <input id="supplierName"
							name="supplierName" type="text" class="input-medium"
							value="${bizUser.supplierName }" />
					</div> --%>
					<div class="input-prepend">
