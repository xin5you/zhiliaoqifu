...
<head>
    ...
    <script src="${ctx}/static/oms/js/retailChnl/retailChnlReserve/listRetailChnlReserve.js"></script>
</head>
<body>
	   <%@ include file="/WEB-INF/views/common/navbar.jsp"%>
            <div id="contentwrapper">
                <div class="main_content">
					...
					<form id="searchForm" action="${ctx }/retailChnl/retailChnlReserve/listRetailChnlReserve.do" class="form-inline" method="post">
