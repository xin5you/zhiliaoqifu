...
<head>
    ...
    <%@ include file="/WEB-INF/views/common/head.jsp"%>
     <script src="${ctx}/static/oms/js/retailChnl/retailChnlProduct/addRetailChnlProduct.js"></script>
</head>
            ...
            <div id="contentwrapper">
                <div class="main_content">
                	<nav>
					 ...
					 <div class="row-fluid">
					 	<div class="span12">
							<form action="${ctx }/retailChnl/retailChnlProduct/addRetailChnlProductCommit.do" id="mainForm"  class="form-horizontal form_validation_tip" method="post" enctype="multipart/form-data" >
