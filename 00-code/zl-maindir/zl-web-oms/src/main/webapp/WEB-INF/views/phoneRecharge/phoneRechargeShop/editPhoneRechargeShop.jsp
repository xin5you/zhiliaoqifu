...
<head>
    ...
    <%@ include file="/WEB-INF/views/common/head.jsp"%>
      ...
      <link href="${ctx }/staticbootstrap-fileinput/css/fileinput.min.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <script src="${ctx}/static/oms/js/phoneRecharge/phoneRechargeShop/editPhoneRechargeShop.js"></script>
</head>
