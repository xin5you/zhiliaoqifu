...
<head>
    ...
    <script src="${ctx}/static/oms/js/retailChnl/retailChnlProduct/listRetailChnlProduct.js"></script>
</head>
<body>
	   <%@ include file="/WEB-INF/views/common/navbar.jsp"%>
            <div id="contentwrapper">
                <div class="main_content">
					...
					<form id="searchForm" action="${ctx }/retailChnl/retailChnlProduct/listRetailChnlProduct.do" class="form-inline" method="post">
