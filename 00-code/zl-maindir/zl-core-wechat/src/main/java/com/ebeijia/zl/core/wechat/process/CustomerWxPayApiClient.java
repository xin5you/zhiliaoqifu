...
public class CustomerWxPayApiClient {
	...
	@Autowired
	private CustomerWxPayApi customerWxPayApi;
	
	@Autowired
	private RedisDictProperties redisDictProperties;

	private  Logger logger = LoggerFactory.getLogger(CustomerWxPayApiClient.class);
	 ...
	 * @return
	 */
	public  JSONObject getRefundOrder(MpAccount mpAccount, String out_trade_no, String out_refund_no,
			String totalFee, String refundFee, HttpServletRequest req) {
		String wxMchntId = redisDictProperties.getdictValueByCode("WX_CUSTOMER_MCH_ID");
		...
		try {
			...
			FileInputStream instream = new FileInputStream(
					new File(redisDictProperties.getdictValueByCode("WX_CUSTOMER_APICLIENT_CERT")));// P12文件目录
			try {
	 ...
	 * @return
	 */
	public  JSONObject unifiedOrder(MpAccount mpAccount, String Out_trade_no, String transAmt, String openId,
			String spbill_create_ip, String notifyUrl) {
		WXPayUnifiedOrderRequest request = new WXPayUnifiedOrderRequest();
		request.setAppid(StringUtil.trim(mpAccount.getAppid()));
		request.setMch_id(redisDictProperties.getdictValueByCode("WX_CUSTOMER_MCH_ID"));
	 ...
	 * @return
	 */
	public  JSONObject orderQuery(MpAccount mpAccount, String out_trade_no) {
	 ...
	 * @return
	 */
	public  JSONObject authCodeOpenId(MpAccount mpAccount, String auth_code) {
