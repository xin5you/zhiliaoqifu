...
import com.ebeijia.zl.core.wechat.vo.AuthCodeReqOpenId;
import com.ebeijia.zl.core.wechat.vo.WXPayOrderQueryRequest;
import com.ebeijia.zl.core.wechat.vo.WXPayRefundRequest;
import com.ebeijia.zl.core.wechat.vo.WXPayUnifiedOrderRequest;
...
public class CustomerWxPayApi {
	...
	public  String getWxPayKey(){
		return redisDictProperties.getdictValueByCode("WX_CUSTOMER_PAY_KEY");
	}
	 ...
	 * @throws Exception
	 */
	public  String getRefundSign(WXPayRefundRequest req) throws Exception {
		...
		StringBuffer buf=new StringBuffer();
		 ...
		 buf.append("key").append("=").append(this.getWxPayKey());
	 ...
	 * @throws Exception
	 */
	public  String genUnifiedOrderSign(WXPayUnifiedOrderRequest req) throws Exception {
		String signTemp = "appid=" + req.getAppid() + "&attach=" + req.getAttach() + "&body=" + req.getBody()
				...
				+ "&total_fee=" + req.getTotal_fee() + "&trade_type=" + req.getTrade_type() + "&key=" + this.getWxPayKey();
		return WxSignUtil.MD5Encode(signTemp).toUpperCase();
	}
	 ...
	 * @return
	 */
	public  String genUnifiedOrderBackSign(JSONObject obj) {
		...
		if (obj != null) {
			...
			sb.append("&key=" + this.getWxPayKey());
	 ...
	 * @return
	 */
	public  String getPaySign(String appId, String timeStamp, String nonceStr, String packageStr) {
		String signTemp = "appId=" + appId + "&nonceStr=" + nonceStr + "&package=" + packageStr + "&signType=MD5"
				+ "&timeStamp=" + timeStamp + "&key=" +this.getWxPayKey();
		return WxSignUtil.MD5Encode(signTemp).toUpperCase();
	}
	 ...
	 * @throws Exception
	 */
	public  String genOrderQuerySign(WXPayOrderQueryRequest req) throws Exception {
		String signTemp = "appid=" + req.getAppid() + "&mch_id=" + req.getMch_id() + "&nonce_str="
				+ req.getNonce_str() + "&out_trade_no=" + req.getOut_trade_no() + "&key=" + this.getWxPayKey();
		return WxSignUtil.MD5Encode(signTemp).toUpperCase();
	}
	 ...
	 * @return
	 */
	public  String  genAuthCodeReqOpenId(AuthCodeReqOpenId req){
		String signTemp = "appid=" + req.getAppid()+"&auth_code=" + req.getAuth_code() + "&mch_id=" + req.getMch_id() + "&nonce_str="
				+ req.getNonce_str() + "&key=" + this.getWxPayKey(); 
		return WxSignUtil.MD5Encode(signTemp).toUpperCase();
	}
	/**
	 * 解析微信支付成功后的返回信息
	...
	public  JSONObject parseWxPayReturnXml(HttpServletRequest request) throws IOException, DocumentException {
	 ...
	 * @return
	 */
	public  String getPayNotifySign(JSONObject obj) {
		StringBuffer sb = new StringBuffer();
		if (obj != null) {
			sb.append("appid=" + StringUtil.trim(obj.getString("appid")));
	 ...
	 * @return
	 */
	public  String getQueryOrderSign(JSONObject obj) {
		StringBuffer sb = new StringBuffer();
		if (obj != null) {
			sb.append("appid=" + StringUtil.trim(obj.getString("appid")));
			if (obj.containsKey("attach")) {
