...
<html>
	<head>
		...
		<script src="${ctx}/static/oms/js/specialAccount/billingType/listBillingType.js"></script>
	</head>
	<body>
		...
		<div id="contentwrapper">
			<div class="main_content">
				...
				<form id="mainForm" action="${ctx }/specialAccount/billingType/listBillingType.do" class="form-inline" method="post">
					<h3 class="heading">账户类型列表</h3>
					<div class="row-fluid" id="h_search">
						<div class="span10">
							<div class="input-prepend">
								<span class="add-on">账户类型名称</span> 
								<input id="name" name="name" type="text" class="input-small" value="${billingTypeInf.name }" />
							</div>
						</div>
			...
			<form class="form-horizontal">
				...
				<div class="modal-body">
					...
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label">账户类型种类</label>
							<div class="controls">
								 <input type="radio" checked="checked" name="type" value="A">A类
							     <input type="radio" name="type" value="B">B类
								<span class="help-block"></span>
							</div>
						</div>
