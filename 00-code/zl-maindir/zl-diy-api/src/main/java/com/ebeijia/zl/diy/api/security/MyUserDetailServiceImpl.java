...
public class MyUserDetailServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		logger.info("登录验证方法");
		// 取得用户的权限
		com.ebeijia.zl.diy.api.system.domain.User users = null;
		try {
	 ...
	 * @return
	 */
	private Set<GrantedAuthority> obtionGrantedAuthorities(com.ebeijia.zl.diy.api.system.domain.User user) {
