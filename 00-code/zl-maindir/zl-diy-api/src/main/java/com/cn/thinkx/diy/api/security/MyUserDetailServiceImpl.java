package com.cn.thinkx.diy.api.security;
...
import com.cn.thinkx.diy.api.system.domain.Resource;
import com.cn.thinkx.diy.api.system.domain.Role;
import com.cn.thinkx.diy.api.system.service.ResourceService;
...
public class MyUserDetailServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		logger.info("登录验证方法");
		// 取得用户的权限
		com.cn.thinkx.diy.api.system.domain.User users = null;
		try {
	 ...
	 * @return
	 */
	private Set<GrantedAuthority> obtionGrantedAuthorities(com.cn.thinkx.diy.api.system.domain.User user) {
