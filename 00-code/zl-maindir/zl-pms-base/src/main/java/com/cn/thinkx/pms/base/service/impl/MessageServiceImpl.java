...
//	private JedisCluster jedisCluster;
	...
	public boolean sendMessage(String phoneNumber, String templateCode, String templateParam) {
		...
		if ("true".equals(flag)) {
			try {
				String product = SMSPropertiesUtils.getProperty("ALIYUN_MSM_PRODUCT");
				String domain = SMSPropertiesUtils.getProperty("ALIYUN_MSM_DOMAIN");
				String accessKeyId = SMSPropertiesUtils.getProperty("ALIYUN_MSM_ACCESSKEYID");
				String accessKeySecret = SMSPropertiesUtils.getProperty("ALIYUN_MSM_ACCESSKEYSECRET");
				String signName = SMSPropertiesUtils.getProperty("ALIYUN_MSM_SIGNNAME");
	...
	public boolean sendMessage(String phoneNumber, String templateCode, String templateParam) {
	 ...
	 public static void main(String[] args) { 
		 ...
		 String str= "{\"code\":\"123456\"}";
		 System.out.println(pro.sendMessage("15575311169", "SMS_144456829", str));
	 }
