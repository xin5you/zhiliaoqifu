...
public interface TbCouponHolderMapper extends BaseMapper<TbCouponHolder> {
	...
	@Select("SELECT COUNT(1) amount,h.coupon_id, h.member_id,h.coupon_code,h.price,h.b_id,h.coupon_name,h.active_start_date,h.active_end_date,h.create_time,p.coupon_desc,p.icon_image,p.tag_unit,p.tag_amount\n" +
