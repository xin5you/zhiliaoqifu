		...
		try {
			...
			if (PHONE_RECHARGE_SWITCH.equals("0")) {
				...
				if (ExceptionEnum.SUCCESS_CODE.equals(result.getCode())) {
					...
					rechargeOrde.setTransStat(TelRechargeConstants.phoneRechargeOrderType.TransStat4.getCode());
				} else {
			...
			if(TelRechargeConstants.phoneRechargeOrderType.TransStat3.getCode().equals(rechargeOrde.getTransStat())){
